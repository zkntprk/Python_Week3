...
#Copyright (c) ${Alphabetical_Order.2021} ${Ozkan TOPRAK}
...
'''
def alphabetical():
    return print('-'.join(sorted([n for n in input('Please enter your alphabetical order list by adding hyphen icon(-) between them :').split('-')])))
